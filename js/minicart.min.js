...
function paymentFn() {
    let money = $('.minicart-subtotal span').text();
    var str =window.location.pathname;
    if(str.indexOf('index') != -1){
        location.href='html/fukuan.html?money='+money+ '';
    }else{
        location.href='fukuan.html?money='+money+ '';
    }
